# Implementation Plan — begit-notifications
...
- [x] 2.1 (P) 送信済み冪等リポジトリ（notification_deliveries）
  ...
  - _Boundary: notification_delivery_repository_
  - _Depends: 1.1_

- [ ] 2.2 (P) 通知リポジトリに anchor / アクティブ通知クエリ追加
...
- [ ] 3.4 ③④⑤⑥ Cron サービス
  ...
  - _Boundary: cron_service_
  - _Depends: 2.1, 2.4, 3.1_

- [ ] 3.5 (P) ⑦ リアクション/コメント通知（自己抑制）
  ...
  - _Boundary: reaction_service, comment_service_
  - _Depends: 3.1_
...
- [ ] 4.4 Workers scheduled ハンドラと Cron トリガー設定
  ...
  - _Requirements: 9.1_
  - _Boundary: src/index.ts, wrangler.toml_
  - _Depends: 4.3_
