...
- **In scope**: Go バックエンド REST API の全エンドポイント実装、D1 データアクセス、FCM Push 通知送信、GitHub API 連携、Webhook 受信処理
- **Out of scope**: iOS クライアント実装、Cloudflare Workers のルーティング設定（Terraform/Wrangler IaC）、Firebase SDK の iOS 側設定、R2 画像ストレージ連携
