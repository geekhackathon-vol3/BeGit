...
<head>
  ...
  <!-- TODO: Add integrity="sha384-..." SRI hash after verifying against official release -->
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/swagger-ui-dist@5.18.2/swagger-ui.css" crossorigin="anonymous">
</head>
<body>
  <div id="swagger-ui"></div>
  <!-- TODO: Add integrity="sha384-..." SRI hash after verifying against official release -->
  <script src="https://cdn.jsdelivr.net/npm/swagger-ui-dist@5.18.2/swagger-ui-bundle.js" crossorigin="anonymous"></script>
  <script>
